...
<center style="width: 100%;" class="bg-body">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600"
        ...
        <tr>
            <td style="padding: 20px 0; text-align: center">
                <img src="{{$logo}}" width="183" height="57" alt="alt_text" border="0">
            </td>
        </tr>
    </table>
    <!-- Email Header : END -->
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600"
            ...
            <td bgcolor="#ffffff" align="center" valign="top" style="padding: 10px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        ...
                        <!-- Column : END -->
                        <!-- Column : BEGIN -->
                        <td class="stack-column-center" valign="middle">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td style="padding: 15px; text-align: center">
                                        <img src="{{$appimg}}" width="256" height="176" alt="silosys"
                                             border="0" class="fluid">
                                    </td>
                                </tr>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
                        <td style="padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                            <hr style="border: 0.4px #bababa solid;">
                            {!! $footer !!}
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td bgcolor="#F8F8F8" align="center" valign="top" style="padding: 10px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <!-- Column : BEGIN -->
                        <td class="stack-column-center" valign="top">
