						...
						@foreach( $groupBy as $key => $group )
							...
							@if( ($commoditie_current.$buyer_current !== $commoditie_old.$buyer_old ) && ( $totalnetdrywt_buyer !== 0 ) )
								<table style="margin-top:0px" class="without_border">
									<tr>
										<td style="" class="without_border"> Total {{ isset($buyer_old) ? $buyer_old : 'N/A' }}</td>
										<td style="" class="without_border"> {{ $totalnetdrywt_buyer }} </td>
									</tr>
								</table>
							@endif
							...
							<table class="without_border">
								...
								@if( $longitud == $count_iteration )
									<tr>
										<td style="" class="without_border"> Total {{ isset($group->buyer_name) ? $group->buyer_name : 'N/A' }}</td>
										<td style="" class="without_border"> {{ $totalnetdrywt_buyer }} </td>
									</tr>
								@endif
								@if( $longitud == $count_iteration )
