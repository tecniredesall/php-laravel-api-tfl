...
<div class="content">
	<div class="panel panel-default">
		<div class="sty_header">
			...
			<p style="text-align: center;"> CONTRACTS BY FARMER REPORT </p>
		</div>
	</div>
				...
				<div class="panel">
					...
					<?php
						...
						@if( ($seller_current !== $seller_old ) && ( $total_seller !== 0 ) )			
							<table style="margin-top:0px" class="without_border">
								<tr class="without_border">
									<td width="93%" class="without_border"> Total {{ isset($seller_old) ? $seller_old : 'N/A' }}</td>
						...
						<table class="without_border">
							...
							?>
							<tr class="without_border">
								<td width="93%" class="without_border">TERM TOTAL: </td>
								<td class="without_border"> $ {{ $table_total_price }}</td>
							</tr>
							@if( $longitud == $count_iteration )
								<tr class="without_border">
									<td width="93%" class="without_border"> Total {{ isset($group->seller_name) ? $group->seller_name : 'N/A' }}</td>
									<td class="without_border"> $ {{ $total_seller }} </td>
								</tr>
							@endif
						</table>
					...
					<?php
					 ...
					 ?>
						<table class="without_border">
							<tr class="without_border">
								<td width="93%" class="without_border">GRAND TOTAL: </td>
