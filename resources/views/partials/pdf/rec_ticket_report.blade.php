...
<div class="content">
	<div class="panel panel-default">
		<div class="sty_header">
			...
			<p style="text-align: center;"> RECEIVE TICKETS REPORT </p>
						...
						@foreach( $groupBy as $key => $group )
							...
							@if( ($commoditie_current.$seller_current !== $commoditie_old.$seller_old ) && ( $totalnetdrywt_seller !== 0 && $totalnet_seller !== 0 ) )
								<table style="margin-top:0px" class="without_border">
									<tr>
										<td class="col-lg-4 col-md-4 col-sm-6 without_border" style="width: 48%"> Total {{ isset($seller_old) ? $seller_old : 'N/A' }}</td>
							...
							@if( ( $commoditie_current !== $commoditie_old ) && ( $totalnetdrywt_commoditie !== 0 && $totalnet_commoditie !== 0 ) )
								<table style="margin-top:0px" class="without_border">
									<tr>
										<td class="col-lg-4 col-md-4 col-sm-6 without_border" style="width: 48%"> Total {{ isset($commoditie_old) ? $commoditie_old : 'N/A' }}</td>
							...
							<table class="without_border">
								<tr>
									<td class="col-lg-4 col-md-4 col-sm-6 without_border" style="width: 48%"> Total {{ isset($group->farm_name) ? $group->farm_name : 'N/A' }}</td>
								...
								@if( $longitud == $count_iteration )
									<tr>
										<td class="col-lg-4 col-md-4 col-sm-6 without_border" style="width: 48%"> Total {{ isset($group->seller_name) ? $group->seller_name : 'N/A' }}</td>
										<td class="col-lg-4 col-md-4 col-sm-6 without_border"> {{ $totalnet_seller }} </td>
										<td class="col-lg-4 col-md-4 col-sm-6 without_border"> {{ $totalnetdrywt_seller }} </td>
									</tr>
								@endif
								...
								@if( $longitud == $count_iteration )
									<tr>
										<td class="col-lg-4 col-md-4 col-sm-6 without_border" style="width: 48%"> Total {{ isset($group->commoditie_name) ? $group->commoditie_name : 'N/A' }}</td>
										<td class="col-lg-4 col-md-4 col-sm-6 without_border"> {{ $totalnet_commoditie }} </td>
										<td class="col-lg-4 col-md-4 col-sm-6 without_border"> {{ $totalnetdrywt_commoditie }} </td>
									</tr>
								@endif
