...
<div class="content">
	<div class="panel panel-default">
		<div class="sty_header">
			...
			<p style="text-align: center;"> RECEIVE TICKETS REPORT BY SILO </p>
				...
				<div class="panel">
					...
					?>
						...
						@if( ( $location_current !== $location_old ) && ( $totalnetdrywt_location !== 0 && $totalnet_location !== 0 ) )
							<table style="margin-top:0px" class="without_border">							
								<tr>
									<td class="col-lg-4 col-md-4 col-sm-6 without_border" style="width: 48%"> Total {{ isset($location_old) ? $location_old : 'N/A' }}</td>
					...
					?>
						...
						<table id="" class="table table-striped table-bordered">
							...
							<table class="without_border">
								...
								?>
								<tr>
									<td class="col-lg-4 col-md-4 col-sm-6 without_border" style="width: 48%"> Total {{ isset($group->date_end) ? $fecha : 'N/A' }}</td>
								...
								@if( $longitud == $count_iteration )
									<tr>
										<td class="col-lg-4 col-md-4 col-sm-6 without_border" style="width: 48%"> Total {{ isset($group->location_name) ? $group->location_name : 'N/A' }}</td>
										<td class="col-lg-4 col-md-4 col-sm-6 without_border"> {{ $totalnet_location }} </td>
										<td class="col-lg-4 col-md-4 col-sm-6 without_border"> {{ $totalnetdrywt_location }} </td>
									</tr>
								@endif
